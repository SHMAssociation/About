...
但是通过无数前驱探索者夜以继日呕心沥血前赴后继地研究，蓝星人终于掌握了一定程度的魔力汲取、利用的技术，那就是魔导技术，但是目前还无法对魔力的本质展开研究。魔导技术与蓝星旧时代的基于物质的科学和技术有本质区别，也被通俗地称为魔法。  
魔法可以以远超传统手工艺或者工业技术的速度产出精美工艺品，而不是专门提供给那些具备艺术才能的少数人。它有能力完成令人惊叹的壮举，从为机器充能到产生可以切割最坚硬的钢铁的光束。但是魔法并不是一种少数人掌握、并且被严格保守的秘密的技术，任何人都有机会便利地获取必要的资料，并且取依照相同的方法来工作。正因如此，魔法也被许多人所恐惧。  
当然，魔法不是万能的，但是伴随魔导技术的发展，魔法在将来必然有更广泛的使用。

## 如何使用魔法
使用魔法必须使用固定了术式的魔导器施法。  
在现在，常见的魔导器包含瑟麻特宏，科莫秀特，以及瑟文三大类型。  
魔法不是无中生有，使用是魔法需要消耗能量的。由于瑟麻特宏和科莫秀特能够打开的能量通道有限，无法直接施放一部分法术，魔导师们又开发了一种由小型魔导器发出请求，大型魔导器接受请求并完成施法，然后反馈施法结果给小型魔导器的技术。这种技术构建的通道，就是魔网，目前魔网已经覆盖蓝星的大部分居住区。
...
申请加入家圣•希娜卡纳魔导结社，您不需要出示学历以及成绩，不需要展示自己的魔法水平或者魔导器。您需要做的只是在此<ruby>存储库<rp>（</rp><rt>repository</rt><rp>）</rp></ruby>打开一个 [issue](https://github.com/HRMAssociation/About/issues/new?assignees=&labels=Join+Request&template=join-request.md&title=Join+Request)并且阐述您想要加入圣•希娜卡纳魔导结社。 
...
我们会提供一个由魔法召唤，并永久存储于区块链魔法网络的唯一徽章作为您的纪念和证明。
